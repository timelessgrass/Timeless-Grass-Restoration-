...
export const GUIDES: Guide[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { h2: 'One-time clean or membership?', html: `<p>Run the numbers on your yard. A one-dog, 800-square-foot yard cleaned twice a year with Premium Restorations is ${money(P.rows[1].premium! * 2)}. The same yard on Essential Care is ${money(P.memberships[0].monthly * 12)} a year for four lighter visits with priority scheduling. If it needs the odor treatment every quarter, four Premium Restorations bought one at a time come to ${money(P.rows[1].premium! * 4)}, slightly less than TIMELESS ELITE at ${money(P.memberships[1].monthly * 12)} a year, so on a yard that size the membership buys priority scheduling and 10% off repairs and add-ons rather than a lower price. Over 1,000 square feet the membership costs less than four separate Premiums: those are ${money(P.rows[2].premium! * 4)} in the 1,001–1,500 band and ${money(P.rows[3].premium! * 4)} in the 1,501–2,000 band. Up to 3,000 square feet, a yard that needs only one or two visits a year is cheaper paid per visit. Our <a href="/guides/one-time-clean-vs-membership/">membership comparison</a> has every band, and the <a href="/guides/how-often-to-clean-artificial-turf/">frequency guide</a> tells you how many visits your yard needs.</p>` },
