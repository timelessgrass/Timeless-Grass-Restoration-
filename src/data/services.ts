...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    description: `White chalky patches on turf are mineral deposits, not fading. Turf-safe removal of hard-water crust, rust, sap and stains. From $50. Call ${brand.phone}.`,
    ...
    plan: 'addon',
    priceLine: 'Spot treatment $50–$150 · included in Premium Restoration where affected',
    faq: [
  ...
  },
  {
    ...
    answer: 'Turf infill needs topping up when the fibers lie flat because there is not enough sand supporting them, when the surface feels hard or drains slowly because the infill has compacted, or when pet zones smell even after treatment because the infill is saturated. TIMELESS Turf Restoration measures infill depth on every visit and redistributes, tops up or replaces it across the Grand Strand, from $0.35 per square foot to redistribute and $0.75–$1.50 per square foot for new infill installed.',
  ...
  },
  {
    ...
    lede: 'A synthetic green is the one piece of turf that has to perform, not just look good. Speed comes from sand depth and how it is rolled; a true roll comes from a level, consistent surface; a clean green is one you can actually blow off. Brian has built and cared for putting greens for thirteen years, and this is the work he is pickiest about.',
