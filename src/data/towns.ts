...
export const TOWNS: Town[] = [
  {
    ...
    blocks: [
      ...
      { h2: 'Putting greens, in the town that has a hundred courses', html: `<p>Pine Lakes Country Club opened in 1927 and is on the National Register; the Dunes Club was built by Robert Trent Jones in 1948 and hosts the PGA Tour's Myrtle Beach Classic. People who move here to be near that golf put greens in their backyards, and a backyard green under a live oak is the surface that needs us most. <a href="/services/putting-green-restoration/">Putting green restoration</a>: cleaned, top-dressed, brushed and rolled by someone who has built greens for thirteen years.</p>` },
    ],
  ...
  },
  {
    ...
    intro: 'Carolina Forest was pine timberland until International Paper and Horry County master-planned it in the mid-1990s, and that history is still in every yard: the ground is sandy flatwoods soil with a hardpan under it, the pollen in March is the heaviest on the Strand, and the 10,000-plus homes in Plantation Lakes, Waterbridge, The Farm, Avalon, Berkshire Forest and the rest are full of families and dogs. The 2020 census found the lowest vacancy rate of any community on the coast here, 11.7 percent, which means these are year-round yards, used every day. That is the turf we clean.',
    ...
    blocks: [
      ...
      { h2: 'Family yards, dogs, and one corner', html: `<p>Carolina Forest's median age is under 40 and a third of households have children; two new elementary schools, Pine Island and Ten Oaks, opened in August 2025 to keep up. The turf here is a play surface and a dog run at the same time, and the dog picks one corner. Berkshire Forest and Indigo Bay run their own HOA dog parks; Camp Bow Wow on Bush Drive does daycare. When the corner starts to smell after a summer storm, the fix is treating the infill in that corner, not spraying the yard: our <a href="/services/pet-odor-removal/">pet odor removal</a>. For the sanitized play surface parents ask about, add <a href="/services/antimicrobial-sanitizing/">antimicrobial sanitizing</a>.</p>` },
    ...
    pets: ['Camp Bow Wow Myrtle Beach (Bush Dr)', 'Berkshire Forest HOA dog park', 'Barc Parc North (nearest city park)'],
    faq: [
  ...
  },
  {
    ...
    blocks: [
      ...
      { h2: 'Two golf clubs, one shared problem', html: `<p>Arrowhead Country Club's 27 holes run along the Waterway and Prestwick, the Pete Dye course, is Socastee High's home track. The backyard greens in the golf-adjacent streets share a problem with the club practice greens: pine straw and oak leaves on the surface all fall, and a green that is not blown off is slow and bumpy by spring. <a href="/services/putting-green-restoration/">Putting green restoration</a> brings the speed and the roll back; blowing it off weekly keeps it.</p>` },
    ...
    pets: ['Dog Boarding at the Beach (Tyner St)', 'K9 Cabana Dog Resort (Dick Pond Rd)', 'Dog Boarding of Myrtle Beach (Hwy 544)', 'Sit and Stay (Forestbrook Rd)', 'Barc Parc South (nearest park)'],
    faq: [
