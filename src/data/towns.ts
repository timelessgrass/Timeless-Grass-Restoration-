...
export const TOWNS: Town[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { h2: 'Dogs and drains', html: `<p>Fur-ever Friends on Highway 9 East runs cage-free boarding and daycare; there is no public dog park in Longs, with Waggin' Tails in Little River the nearest. The dogs here have room to run, which spreads the pet load out, so odor in a Longs yard usually comes from the one spot by the back door rather than the whole yard. Longs is unincorporated Horry County, so rinse water follows the county stormwater ordinance (Chapter 17.7); on acreage the rinse goes into the ground, and we still bag solids and let treatments dwell.</p>` },
    ],
